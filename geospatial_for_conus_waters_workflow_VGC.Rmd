...
knit: (
  function(inputFile, encoding) { 
    ...
    pSubTitle <- paste0("Geospatial_",Sys.Date())
...
```
```{r}
siteplot = subset(site_watersheds, site_watersheds$site == c('W10'))
siteplot2 = subset(site_watersheds, site_watersheds$site == c('W20'))
sitex = subset(sites, sites$site == c('W10'))
sitey = subset(sites, sites$site == c('W20'))
mapview(siteplot, col.regions = "#56B4E9", alpha.regions = 0.2, lwd = 3, layer.name = "Watershed") +
  mapview(siteplot2, col.regions = "#56B4E9", alpha.regions = 0.2, lwd = 3, layer.name = "Watershed")+
  mapview(sitex, cex = 5, col.regions = "black", layer.name = "Points") + 
  mapview(sitey, cex = 5, col.regions = "black", layer.name = "Points") + 
  mapview(st_read('data/site_flowlines.gpkg', quiet = T), lwd = 3, color = "red", layer.name = "Flowline")
```
